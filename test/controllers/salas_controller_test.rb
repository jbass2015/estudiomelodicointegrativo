...
class SalasControllerTest < ActionController::TestCase
  ...
  test "should create sala" do
    assert_difference('Sala.count') do
      post :create, sala: { salaBasica: @sala.salaBasica, salaFull: @sala.salaFull, salaMedia: @sala.salaMedia }
    end
  ...
  test "should update sala" do
    patch :update, id: @sala, sala: { salaBasica: @sala.salaBasica, salaFull: @sala.salaFull, salaMedia: @sala.salaMedia }
    assert_redirected_to sala_path(assigns(:sala))
  end
